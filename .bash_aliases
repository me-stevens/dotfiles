...
alias beproudweb="clear && be rake test:web TESTOPTS='--pride'"
alias beproudall="clear && be rake test:all TESTOPTS='--pride'"
alias beclean="clear && be rake clean default"
alias bescraper="clear && be ruby scraper.rb"
alias bert="be ruby -I'lib:test'"

# In /etc/environment, add this: export DATOS="PATH_HERE"
# In /etc/bash.bashrc comment all after "sudo hint"
...
# IntelliJ
alias idea="/opt/idea-IC-173.4548.28/bin/idea.sh"
#alias idea="/opt/idea-IC-145.1617.8/bin/idea.sh"
...
# Selenium server
alias selenium-server="xvfb-run java -Dwebdriver.chrome.driver=/usr/bin/chromedriver -jar /opt/selenium-server/selenium-server-standalone-3.9.1.jar"

# Restore permissions
alias resetpermissions="chmod -R a=r,a+X,u+w ."

# Altmetric
if [ -f ~/.altmetric.bash ]; then
  . ~/.altmetric.bash
fi
